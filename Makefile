...
IMAGE_TAG          := latest
REBASE_URL         := "github.com/rakibhoossain/go-whatsapp-multidevice-rest"
...
rebase:
	rm -rf .git
	find . -type f -iname "*.go*" -exec sed -i '' -e "s%github.com/rakibhoossain/go-whatsapp-multidevice-rest%$(REBASE_URL)%g" {} \;
	git init
